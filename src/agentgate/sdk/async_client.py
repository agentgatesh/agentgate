...
class AsyncAgentGateClient:
    ...
    async def get_org_wallet(self, org_id: str) -> dict:
        r = await self._client.get(
    ...
    async def topup_org(self, org_id: str, amount: float) -> dict:
        r = await self._client.post(
    ...
    async def get_org_transaction_summary(self, org_id: str) -> dict:
        r = await self._client.get(
    ...
    async def get_deploy_status(self, agent_id: str) -> dict:
    ...
    async def get_deploy_logs(self, agent_id: str, tail: int = 100) -> dict:
    ...
    async def undeploy_agent(self, agent_id: str) -> dict:
